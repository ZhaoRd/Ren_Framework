/*
namespace Zhaord.Web.Framework.Attributes
{
    using System;
    ...
    using Zhaord.Web.Framework.Controllers;
    ...
    [StoreIpAddress]
    public abstract class AdminControllerBase : SkymateController
    { 
        /// <summary>
        ...
        {
            this.AddLocales(languageService, locales, null);
        }
