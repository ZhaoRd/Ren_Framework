...
::nuget.exe pack ..\1-Infrastructure\Skymate.Infrastructure\Skymate.csproj -Build -Properties Configuration=Release
...
::nuget.exe pack ..\1-Infrastructure\Skymate.Data.EntityFramework\Skymate.EntityFramework.csproj -Build -Properties Configuration=Release
